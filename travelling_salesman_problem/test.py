...
my_first_city_storage = CityStorage.with_given_cities(first_test_array)
my_second_city_storage = CityStorage.with_given_cities(second_test_array)
my_random_city_storage = CityStorage(10)

perform_sample_algorithm(my_first_city_storage)
print_delimeters()
perform_sample_algorithm(my_second_city_storage)
print_delimeters()
perform_sample_algorithm(my_random_city_storage)
print_delimeters()
